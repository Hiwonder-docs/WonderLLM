...
>[!note]
> **To modify the wake word, open the ([Command Word Broadcast Protocol List V3_English Template](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)) table, and change "HELLO-HIWONDER" to the desired wake word. > The English version of the wake word can only be triggered by an English word, and it must be in uppercase to work.**
...
[1.10.2 Command Word Broadcast Protocol List](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)
...
[ 1.10.4 CI1302 Firmware Flashing Tool](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)



### 1.10.5 Factory Firmware

[ 1.10.5 Factory Firmware](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)
...
1. Please open the **flash_download_tool_3.9.7.exe** file located inside the [1.11.2 ESP32 Firmware Flashing Tool \ flash_download_tool_3.9.7](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2) compressed folder.
...
3. Once the tool is open, click "**...**" to select the program .bin file you want to flash. This example uses Hiwonder factory firmware **WonderLLM.bin** (path: [“Appendix\05 ESP32S3 Factory Firmware”](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)):
...
[ 1.11.2 ESP32 Firmware Flashing Tool](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)



### 1.11.3 ESP32S3 Firmware

[ 1.11.3 ESP32S3 Firmware](https://pan.baidu.com/s/1dEzSQH2UxW_UqMbu0DZ-Dg?pwd=upx2)
