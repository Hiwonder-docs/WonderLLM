...
Next, upload the command word configuration file. Navigate to the spreadsheet titled **Command Word Broadcast Protocol List V3_English Template**(path in **[1.10 Wake Word Modification\1.10.2 Command Word Broadcast Protocol List](https://wiki.hiwonder.com/projects/WonderLLM/en/latest/docs/1.%20Basic_Course.html#command-word-broadcast-protocol-list)**). Simply drag and drop the file into the upload area on the webpage. 
