...
<img src="..\_static\media\chapter_1\section_1\media\image1.png"     class="common_img"  style="width:200px"  class="common_img"/>
...
2. Click the <img src="..\_static\media\chapter_1\section_2\media\image10.png" style="width:50px" /> icon corresponding to any saved hotspot connection to delete it.
   Click the <img src="..\_static\media\chapter_1\section_2\media\image11.png" style="width:50px" /> icon to raise its priority in hotspot matching during module network configuration. The list is prioritized from top to bottom.
...
>
>  <img src="../_static\media/chapter_1/section_3/media/image2.png" style="width:400px"  class="common_img"/>
...
<img src="../_static\media/chapter_1/section_4/media/image3.png"  style="width:400px"  class="common_img"/>

4. When entering Chat Mode by **short pressing the right button**, the module **starts listening immediately**.

<img src="../_static\media/chapter_1/section_4/media/image4.png" style="width:400px"  class="common_img"/>
...
<img src="../_static\media/chapter_1/section_5/media/image1.png" style="width:500px"  class="common_img"/>
...
1. First, click [**Chipintelli official website**](https://chipintelli.com/en/) and then click **Platform** to access the firmware creation website.

   <img src="../_static\media/chapter_1/section_7/media/image1_1.png"   class="common_img" />

2. The system will prompt for login. If no account has been created, complete the registration first. In this example, registration has already been completed.

   <img src="../_static\media/chapter_1/section_7/media/image1_2.png"   class="common_img" />

3. After successfully logging in, click on **Offline Speech Recognition LM Application** first.

<img src="../_static\media/chapter_1/section_7/media/image2_1.png"   class="common_img" />

4. In the submenu, click the **Firmware & SDK Development** entry.

   <img src="../_static\media/chapter_1/section_7/media/image3_1.png"   class="common_img" />

5. After the page redirects, click on<img src="../_static\media/chapter_1/section_7/media/image4_1.png"  /> on the left. Then create a new product as shown in the  image below. The product name and description can be customized. For the application scheme, select **Single-mic ASR**.

6. In the pop-up options for the product type, select **General -> Smart Hub**.

   <img src="../_static\media/chapter_1/section_7/media/image5_1.png"   class="common_img" />

7.  Choose **CI1302** for the chip model and **CI13XX_SDK_ASR_Offline** for the SDK name. Select the SDK version as **1.12.16**. Once all options are configured, click **Create**.
...
9. After entering the firmware configuration interface, proceed with the steps for modifying key parameters. First, navigate to the **Algorithm** section and enable the **AEC** function.

   <img src="../_static\media/chapter_1/section_7/media/image9.png"   class="common_img" />

10. In the **Hardware** section, set the **Clock Source** to **Internal RC** and **disable Baud Rate Calibration Feature**.

    <img src="../_static\media/chapter_1/section_7/media/image10.png"   class="common_img" />

11. In **Debug Port** section, enable **UART0 Signal Level** to open-drain Mode, supporting external 5V pull-up.

    <img src="../_static\media/chapter_1/section_7/media/image11.png"   class="common_img" />

12. Modify the **communication port** configuration, set the Baud Rate to **115200** and enable **UART1** to Open-Drain Mode, also supporting external 5V pull-up. After adjusting these settings, click **Continue** to move forward.

    <img src="../_static\media/chapter_1/section_7/media/image12.png"   class="common_img" />

13. The next step involves configuring the command words. First, choose a voice output. Here, selecting **David Ver.3** as an example. 
...
>* **The CI1302's broadcasting function will not be used in later applications, so any tone can be chose here.**

<img src="../_static\media/chapter_1/section_7/media/image13.png"   class="common_img" />

Next, upload the command word configuration file. Navigate to the spreadsheet titled **Command Word Broadcast Protocol List V3_English Template**, which located in **[1.10 Wake Word Modification\1.10.2 Command Word Broadcast Protocol List](https://wiki.hiwonder.com/projects/WonderLLM/en/latest/docs/1.%20Basic_Course.html#command-word-broadcast-protocol-list)**. Simply drag and drop the file into the upload area on the webpage. 
...
15. After uploading the file, the command word data is shown in the table below. Scroll to the bottom of the page and click **Submit**.
...
17. After the firmware finishes downloading, extract the compressed package to obtain a **.bin** file. This file can be flashed onto the CI1302 chip via a dedicated firmware flashing tool.

    

### 1.10.2 Command Word Broadcast Protocol List

Click here to access to the [Command Word Broadcast Protocol List](https://drive.google.com/drive/folders/1qf5ASemVcSWy26ki2qEDNXeF4Wmm1ri5?usp=sharing).
...
2. Open the **[Firmware Flashing Tool](https://drive.google.com/drive/u/1/folders/15ECqhqEV-WW8Y6hQWF97_0UHULP_G5Uh)** located in the same path, and run the **PACK_UPDATE_TOOL.exe** file. Select the **CI1302** chip, then click **Firmware Upgrade**.

   <img src="../_static\media/chapter_1/section_7/media/image1.png"   class="common_img" />
> [!note]
> **Taking flashing the "hello hiwonder firmware (wake word: HELLO HIWONDER)" located in "[Appendix\03 CI1302 Factory Firmware](https://drive.google.com/drive/u/0/folders/1UZne5lmAXV7sJCrna4Ev4CfX2jSXEU5n)" as an example.**
...
Click here to access to the [CI1302 Firmware Flashing Tool](https://drive.google.com/drive/folders/15ECqhqEV-WW8Y6hQWF97_0UHULP_G5Uh?usp=sharing).



### 1.10.5 Factory Firmware

Click here to access to the [Factory Firmware](https://drive.google.com/drive/folders/1UZne5lmAXV7sJCrna4Ev4CfX2jSXEU5n?usp=sharing).
...
>* **For usage instructions on the “Xiaozhi AI Open-Source Program Firmware,” please refer to [“2. Advanced Course \ 2.5 Xiaozhi Open-Source Program.”](https://drive.google.com/drive/u/1/folders/1P98vqstIDOsK8vNw92ARXuD0k1yKVjFx)**
...
3. Once the tool is open, click "**...**" to select the target **.bin** file for flashing. This example uses Hiwonder factory firmware **WonderLLM.bin**, which path in [“Appendix\05 ESP32S3 Factory Firmware”](https://drive.google.com/drive/folders/1PiyCTOYUr2eoSPwD8FcVWMvyPyUMwEdH?usp=sharing).
...
Click here to access to the [ESP32 Firmware Flashing Tool](https://drive.google.com/drive/folders/1UXDER-ybQFNjeqTb6ZOad0RnxqBIA-if?usp=sharing).



### 1.11.3 ESP32S3 Firmware

Click here to access to the [ESP32S3 Firmware](https://drive.google.com/drive/folders/1PiyCTOYUr2eoSPwD8FcVWMvyPyUMwEdH?usp=sharing).
