...
<img src="../_static/media/chapter_4/section_1/media/image1.png"   class="common_img"   class="common_img"/>
...
<img src="../_static/media/chapter_4/section_1/media/image2.png"   class="common_img"   class="common_img"/>



2. **External Controller Communication Process**

<img src="../_static/media/chapter_4/section_1/media/image2_1.png"   class="common_img"   class="common_img"/>



<img src="../_static/media/chapter_4/section_1/media/image3.png"   class="common_img"   class="common_img"/>
...
<img src="../_static/media/chapter_1/section_7/media/image21.png"    class="common_img"/>
...
3. Click **Select firmware**, and find the CI1302 factory firmware in the **"[Appendix/02 CI1302 Factory Firmware]()"** path.
...
<img src="../_static/media/chapter_1/section_7/media/image22.png"   class="common_img"   class="common_img"/>
...
<img src="../_static/media/chapter_1/section_8/media/image10.png"   class="common_img"   class="common_img"/>
...
3. After opening the tool, click **"..."** to select the program bin file to be flashed which stored in the path: **"[Appendix/03 ESP32S3 Firmware]()"**.
...
1. In the **"[Appendix/05 Command Word Broadcast Word Protocol List/01 Command Word Protocol List]()"** path, find the corresponding **"Command Word Broadcast Word Protocol List"** for the factory firmware. Copy it to another location for backup, and changes will be made on the backup file.
...
1. In the **"[Appendix/05 Command Word Broadcast Word Protocol List/02 Broadcast Word Protocol List]()"** path, find the **Broadcast Word V3_English_Template** corresponding to the factory firmware. Copy it to another location for backup. All subsequent changes will be made to this backup file. Open the backup file.
...
10. In the path **["Appendix/11 Audio Conversion Tool"]()**, locate the compressed file for the audio conversion tool installation package. Set up the working environment for the tool as detailed in **[4.8.3 Audio Conversion Tool Environment Setup (Optional)](#4.8.3)**.
...
15. In the path **["Appendix/12 WonderLLM Offline Voice Function Source Code"]()**, locate the corresponding version. Copy and paste the source project to another location for backup.
...
20. Expand the **Announcement** folder. It can be seen that all the term audio files matching the factory firmware have already been pre-stored in this path "**[Appendix/ 05 Command Word Broadcast Word Protocol List/ 01 Command Word Protocol List/Command Word Broadcast Protocol List]()**" and "**[Appendix/05 Command Word Broadcast Word Protocol List/02 Broadcast Word Protocol List//Broadcast Word V3_English_Template]()**" files).
...
1. In the path **["Appendix/05 Command Word Broadcast Word Protocol List/01 Command Word Protocol List"]()**, locate the **Command Word Broadcast Word Protocol List** document corresponding to the factory firmware. This document is the communication protocol between the CI1302 chip and the ESP32S3 chip.
...
1. Open the **Hiwonder Python Editor** software <img src="../_static/media/chapter_2/section_2/media/image1.png"   class="common_img" /> which located in [**"Appendix/ 14 Hiwonder Python Editor"**]().
...
> [!NOTE]
>**After completing the above 4 steps, please drag the WonderLLM offline speech feature communication library into the editor, which located in ["Appendix\07 ESP32 Program Files\01 ESP32 Speech Recognition Example\hw_esp32ASR_ctl.py"](). Follow the same steps to import the library file into the ESP32. After downloading, click the reset icon on the interface <img src="../_static/media/chapter_3/section_8/media/image6_2.png"   class="common_img" /> to reset the ESP32. The output information will be displayed in the output information bar below.**
