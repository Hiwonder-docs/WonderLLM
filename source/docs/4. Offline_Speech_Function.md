...
> [!NOTE]
>
>* **For a better understanding, it is recommended to study the "Command Word Broadcast Protocol List" file in "[Appendix/05 Command Word Broadcast Protocol List](https://drive.google.com/drive/u/0/folders/1LfRt9qwhy3T34_WiH7H21B4ihLWIDLK7)".**
...
<img src="../_static/media/chapter_4/section_1/media/image2_1.png"   class="common_img"   style="width:40%"  />
...
<img src="../_static/media/chapter_1/section_7/media/image21.png"  style="width:40%"  class="common_img"/>

2. Open the **"[Appendix/01 CI1302 Firmware Flashing Tool](https://drive.google.com/drive/u/0/folders/1XzqaPhGaPzEvC8vRGvTbVPqfxz5LBIA_)"** path and run the **PACK_UPDATE_TOOL.exe** file. Select the **CI1302** chip and then click **Firmware Upgrade**.
...
3. Click **Select firmware**, and find the CI1302 factory firmware in the **"[Appendix/02 CI1302 Factory Firmware](https://drive.google.com/drive/u/0/folders/1Bj_dGx9UBpIfUk70IrcTjRU58iKVLfmf)"** path.
...
<img src="../_static/media/chapter_1/section_7/media/image22.png"   class="common_img" />
...
<img src="../_static/media/chapter_1/section_8/media/image10.png"   class="common_img"  style="width:40%" />
...
1. Please open the **"[Appendix/04 ESP32 Firmware Flashing Tool/flash_download_tool_3.9.7](https://drive.google.com/drive/u/0/folders/1EsuemS-qfJIfrfuXSO1L7Dz4EDu6acTh)"** path and run the **flash_download_tool_3.9.7.exe** file.
...
3. After opening the tool, click **"..."** to select the program bin file to be flashed which stored in the path: **"[Appendix/03 ESP32S3 Firmware](https://drive.google.com/drive/u/0/folders/1vKvWYVvolfIpEL6ispEHF0wkGBBL9N_-)"**.
...
1. The WonderLLM module's factory firmware predefines 4 command words that can be modified via voice, as shown below:

<img src="../_static/media/chapter_4/section_4/media/image3.png"    class="common_img" />

2. Usage example is as follows:
...
1. In the **"[Appendix/05 Command Word Broadcast Word Protocol List/01 Command Word Protocol List](https://drive.google.com/drive/u/0/folders/1ufFHIUHM1209vsACrtk2B3IMSeYLzfOK)"** path, find the corresponding **"Command Word Broadcast Word Protocol List"** for the factory firmware. Copy it to another location for backup, and changes will be made on the backup file.
...
1. In the **"[Appendix/05 Command Word Broadcast Word Protocol List/02 Broadcast Word Protocol List](https://drive.google.com/drive/u/0/folders/1fbLKssaf1tC_UnnAMwdtvt2TwzlMvgD1)"** path, find the **Broadcast Word V3_English_Template** corresponding to the factory firmware. Copy it to another location for backup. All subsequent changes will be made to this backup file. Open the backup file.

> [!NOTE]
>
> * **Do not make direct changes to the original file to avoid irreversible errors.**

2. In this table, there are three columns: **Serial Number**, **Audio Name**, and **Synthesis Content**, which correspond to the **Semantic Label**, **Command Word**, and **Broadcast Statement** columns in the **Command Word Broadcast Word Protocol List** file located in **"[Appendix/05 Command Word Broadcast Word Protocol List/01 Command Word Protocol List](https://drive.google.com/drive/u/0/folders/1ufFHIUHM1209vsACrtk2B3IMSeYLzfOK)"**.
...
> [!NOTE]
>
>* **The CI1302 firmware has a self-learning feature, allowing certain personalized needs to be implemented based on the original firmware without the need to create a new one. > It is recommended to first complete [4.3 Modify Wake Words](#4.3), [4.4 Modify Command Words](#4.4), [4.5 Modify Functional Entries](#4.5), [4.6 Add New Command Entries](#4.6), and [4.7 Add Broadcast Words](#4.7) sections.**
...
4. In the submenu, click the **Offline speech recognition large model application** entry.
...
The product name and description can be customized. For the application scheme, select **Single microphone voice recognition**.
...
7. Then fill in the basic information for the project. Select **English** for the language type. Fill in the other information as shown in the image, and then click **Continue** to proceed.
   ...
   To configure for English recognition, follow the same steps with the corresponding settings.
...
10. In the path **["Appendix/11 Audio Conversion Tool"](https://drive.google.com/drive/u/0/folders/1hZTSiCvEmv_yMOxTafuhboUf03Sri0tF)**, locate the compressed file for the audio conversion tool installation package. Set up the working environment for the tool as detailed in **[4.8.3 Audio Conversion Tool Environment Setup (Optional)](#4.8.3)**.

> [!NOTE]
>
> **The environment setup is required only for the first use. For subsequent uses, skip this step.**

11. In the path **["Appendix/11 Audio Conversion Tool"](https://drive.google.com/drive/u/0/folders/1hZTSiCvEmv_yMOxTafuhboUf03Sri0tF)**, locate the audio conversion script file **MP3 to ogg.bat** and copy it to the previously opened **mp3** folder.
...
15. In the path **["Appendix/12 WonderLLM Offline Voice Function Source Code"](https://drive.google.com/drive/u/0/folders/1noKYlzcTuzV_9oSqdZb3qPUnYPpdMcG0)**, locate the corresponding version. Copy and paste the source project to another location for backup.
...
<img src="../_static/media/chapter_4/section_8/media/image36.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image37.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image38.png"   class="common_img" />

20. Expand the **Announcement** folder. It can be seen that all the term audio files matching the factory firmware have already been pre-stored in this path "**[Appendix/ 05 Command Word Broadcast Word Protocol List/ 01 Command Word Protocol List/Command Word Broadcast Protocol List](https://drive.google.com/drive/u/0/folders/1ufFHIUHM1209vsACrtk2B3IMSeYLzfOK)**" and "**[Appendix/05 Command Word Broadcast Word Protocol List/02 Broadcast Word Protocol List//Broadcast Word V3_English_Template](https://drive.google.com/drive/u/0/folders/1fbLKssaf1tC_UnnAMwdtvt2TwzlMvgD1)**" files).

<img src="../_static/media/chapter_4/section_8/media/image39.png"   class="common_img" />

21. Open the **mp3/output** folder mentioned in step 14. If any type of term has been **added/modified** in the original factory firmware (the operations in **[4.5 Modify Functional Entries](#4.5)**, **[4.6 Add New Command Entries](#4.6)**, and **[4.7 Add Broadcast Words](#4.7)**, all the .ogg audio files for the modified entries need to be pasted into the **main/assets/locales/en-US/Announcement** path of the backup source project, in sequence.


<img src="../_static/media/chapter_4/section_8/media/image40.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image41.png"   class="common_img" />

<img src="../_static/media/chapter_4/section_8/media/image42.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image43.png"   class="common_img" />

25. Locate and open the code under the **"/#elif CONFIG_LANGUAGE_EN_US"** branch.

<img src="../_static/media/chapter_4/section_8/media/image45.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image46.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image47.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image48.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image44.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image49.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image50.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_8/media/image52.png"   class="common_img" />

<img src="../_static/media/chapter_4/section_8/media/image51.png"   class="common_img" />
...
> [!NOTE]
>
> **After ESP-IDF compilation is complete, a build folder will be generated in the root directory of the project to store the compiled output files, including the `AiXiaoZhi_Hiwonder.bin` file. This firmware can later be flashed to the ESP32S3 controller following the "[4.2.2 ESP32S3 Firmware Flashing](#4.2.2)" method.**
>
...
1. In the path **"[Appendix/11 Audio Conversion Tool](https://drive.google.com/drive/u/0/folders/1hZTSiCvEmv_yMOxTafuhboUf03Sri0tF)"**, locate the audio conversion tool installation package and copy it to any directory.
...
1. In the path **["Appendix/05 Command Word Broadcast Word Protocol List/01 Command Word Protocol List"](https://drive.google.com/drive/u/0/folders/1ufFHIUHM1209vsACrtk2B3IMSeYLzfOK)**, locate the **Command Word Broadcast Word Protocol List** document corresponding to the factory firmware. This document is the communication protocol between the CI1302 chip and the ESP32S3 chip.
...
<img src="../_static/media/chapter_3/section_7/media/image3_1.png"   class="common_img" />
...
(2) Open the **[Appendix/06 Arduino Program Files/01 Arduino Speech Recognition Example/ASRcontrol/ASRcontrol.ino](https://drive.google.com/drive/u/0/folders/1auOOVkTJkzLPK_JhKVO7fiO4KCmGvtol)** program file in the same path as this document.

<img src="../_static/media/chapter_4/section_11/media/image2.png"  class="common_img"/>

(3) Select Arduino UNO as the development board and choose the correct port number.

<img src="../_static/media/chapter_4/section_11/media/image3.png"  class="common_img"/>

(4) Click <img src="../_static/media/chapter_4/section_11/media/image4.png"  /> to download the program to the Arduino and wait for the download to complete.

<img src="../_static/media/chapter_4/section_11/media/image5.png"  class="common_img"/>

<img src="../_static/media/chapter_4/section_11/media/image6.png" class="common_img" />
...
(2) Open the **[Appendix/06 Arduino Program Files/02 Arduino Speech Boradcast Example/ASRcontrol/ASRcontrol.ino](https://drive.google.com/drive/u/0/folders/1K8Y7wBDmxsn6tMFf9y7jD2etm1p09SJa)** program file in the same path as this document.

<img src="../_static/media/chapter_4/section_11/media/image2_1.png"  />

(3) Select Arduino UNO as the development board and choose the correct port number.

<img src="../_static/media/chapter_4/section_11/media/image3.png"  />

(4) Click <img src="../_static/media/chapter_4/section_11/media/image4.png"  /> to download the program to the Arduino and wait for the download to complete.

<img src="../_static/media/chapter_4/section_11/media/image5.png"  />

<img src="../_static/media/chapter_4/section_11/media/image6.png"  />
...
(2) Open the **[Appendix/06 Arduino Program Files/03 Arduino Address Modification Example/asr_IICaddr_change/asr_IICaddr_change.ino](https://drive.google.com/drive/u/0/folders/1tkuDeir3tGW9LxMK2cmCGUQ6CAwvEaty)** program file in the same path as this document.

<img src="../_static/media/chapter_4/section_11/media/image2_2.png"  />
...
> * **If using ESP32, make sure that the MicroPython firmware is already installed on the ESP32 before downloading MicroPython. For firmware downloads, please visit the MicroPython official website. If using our ESP32 core board, flash the firmware file provided by Hiwonder, which located in ["Appendix\13 ESP32 Core Board Firmware and Flashing Tool\02 ESP32 Firmware Flashing Tool"](https://drive.google.com/drive/folders/1lnoVD6RJ4o11fkOQ_r5AFhw2XHhCZ-4S). For flashing instructions, please refer to the document in the same path.**

1. Open the **Hiwonder Python Editor** software <img src="../_static/media/chapter_2/section_2/media/image1.png"   class="common_img" /> which located in [**"Appendix/ 14 Hiwonder Python Editor"**](https://drive.google.com/drive/u/0/folders/1546sJV118o6IY1YWPyfFoVYi1iyYoryq).

2. Drag the file "**[Appendix\07 ESP32 Program Files\01 ESP32 Speech Recognition Example\main.py](https://drive.google.com/drive/u/0/folders/1oWwgDlUDYtRCjlDBlyEhH2EMPPA6qipV)**" from this document's path into the Hiwonder Python editor. Make sure to drag it into the red-framed area for it to be valid.

   <img src="../_static/media/chapter_2/section_2/media/image2.png"   class="common_img" />

3. Click the connect button in the menu bar <img src="../_static/media/chapter_2/section_2/media/image3.png"  />. After a successful connection, the icon will turn green <img src="../_static/media/chapter_2/section_2/media/image4.png"   class="common_img" />.

4. After successful connection, click the download button on the menu bar <img src="../_static/media/chapter_2/section_2/media/image5.png"   class="common_img" />, to download the program to the ESP32. Wait for the prompt in the information interaction box below to indicate that the download is complete.

   <img src="../_static/media/chapter_2/section_2/media/image6.png"   class="common_img" />

> [!NOTE]
>**After completing the above 4 steps, please drag the WonderLLM offline speech feature communication library into the editor, which located in ["Appendix\07 ESP32 Program Files\01 ESP32 Speech Recognition Example\hw_esp32ASR_ctl.py"](https://drive.google.com/drive/u/0/folders/1oWwgDlUDYtRCjlDBlyEhH2EMPPA6qipV). Follow the same steps to import the library file into the ESP32. After downloading, click the reset icon on the interface <img src="../_static/media/chapter_3/section_8/media/image6_2.png" /> to reset the ESP32. The output information will be displayed in the output information bar below.**
...
<img src="../_static/media/chapter_4/section_12/media/image1.png"   class="common_img" />
...
<img src="../_static/media/chapter_4/section_12/media/image2.png"   class="common_img" />
...
(5) Click the **File** button on the software interface, select the file "**[Appendix\08 STM32 Program/ 01 STM32 Speech Recognition Example\STM32F407_ASR_recognition/MDK-ARM/RosRobotControllerM4/RosRobotControllerM4.hex](https://drive.google.com/drive/u/0/folders/1z6kuXNjB7aBxrPJ7f9j5nTbD09oEktOu)**" for programming.
...
(5) Click the **File** button on the software interface, select the file ["**Appendix\08 STM32 Program/ 02 STM32 Speech Broadcast Example\STM32F407_ASR_announce/MDK-ARM/RosRobotControllerM4/RosRobotControllerM4.hex**"](https://drive.google.com/drive/u/0/folders/1zs7O1xxLZrrJsw_bGqCEySN1lg0dwOMF) for programming.
...
(5) Click the **File** button on the software interface, select the file "**[Appendix\08 STM32 Program/ 03 STM32 Module Address Modification Example\STM32F407_ASR_IICaddr_change/MDK-ARM/RosRobotControllerM4/RosRobotControllerM4.hex](https://drive.google.com/drive/u/0/folders/1Pqu61zObwbYFg2mlztSx1-ihxSuu6-rk)**" for programming.
...
<img src="../_static/media/chapter_3/section_10/media/image4.png"   class="common_img" />
...
(2) Upload the example file from "**[Appendix\09 Raspberry Pi Program Files\01 Raspberry Pi Speech Recognition Example](https://drive.google.com/drive/u/0/folders/169EpP9ZdkrJeQJ4LmVhSpGWq8Y17sO9c)**" in the same directory as this document to any path on the Raspberry Pi using SSH or other methods.

<img src="../_static/media/chapter_3/section_10/media/image5.jpeg"   class="common_img" />

(3) In the menu bar, click: **"TOOLS" -- "Open Current Folder in Terminal"** to open the command line in the current directory.

<img src="../_static/media/chapter_3/section_10/media/image6.jpeg"   class="common_img" />
...
<img src="../_static/media/chapter_3/section_10/media/image7.jpeg"   class="common_img" />
...
(2) Upload the example file from "**[Appendix\09 Raspberry Pi Program Files\02 Raspberry Pi Speech Broadcast Example](https://drive.google.com/drive/u/0/folders/1Vx6pcs1EG_HcHhD7Byn1zM_j2wArEbyW)**" in the same directory as this document to any path on the Raspberry Pi using SSH or other methods.
...
(2) Upload the example file from "**[Appendix\09 Raspberry Pi Program Files\03 Raspberry Pi Module Address Modification Example](https://drive.google.com/drive/u/0/folders/1H_8Pkait7AX2Oj2WDmCaG5uY_cnSf738)**" in the same directory as this document to any path on the Raspberry Pi using SSH or other methods.
...
<img src="../_static/media/chapter_4/section_15/media/image1.png"   class="common_img" /> 
...
<img src="../_static/media/chapter_4/section_15/media/image1_1.png"   class="common_img" />
...
(1) Click the icon in the lower-left corner of the interface <img src="../_static/media/chapter_4/section_15/media/image2.png" style="width:40px"  />. Then click **Connect Device** and follow the on-screen instructions to connect the micro:bit mainboard.

<img src="../_static/media/chapter_4/section_15/media/image3.png" class="common_img" />

<img src="../_static/media/chapter_4/section_15/media/image4.png" class="common_img" />

(2) Click the **Download** button in the bottom-left corner to flash the program.

<img src="../_static/media/chapter_4/section_15/media/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_4/section_15/media/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_4/section_15/media/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_4/section_15/media/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_4/section_15/media/image7_1.png"   class="common_img"/>
