...
1. Open the "**Hiwonder Python Editor**" software <img src="../_static/media/chapter_2/section_2/media/image1.png"  style="width:50px" /> which located in **"[Appendix\09 Hiwonder Python Editor]()"**.
