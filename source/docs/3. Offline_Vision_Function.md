...
1. Locate the ArduinoIDE installation package at the path **"[Appendix\01 WonderLLM Development Environment Package\01 ArduinoIDE Installation Package](https://drive.google.com/drive/u/0/folders/1SKm4I1_v5vTD4IbuGCXDaDrrT6ZWX0O_)"**, as shown below, and double-click to open. To download the latest version of the software, visit the official Arduino website: [**https://www.arduino.cc/en/software**](https://www.arduino.cc/en/software).
...
3. Finally, double-click the **esp32_package_2.0.12_arduinome.exe** file located in **"[Appendix\01 WonderLLM Development Environment Package\02 ESP32 Module Firmware Package](https://drive.google.com/drive/u/0/folders/1knOcnCjOijFbr3u2qCq3rc3KXRvtFKM3)"**, and wait for the installation to complete.
...
1. This section demonstrates how to upload a simple program that prints the text **hiwonder**. Double-click to open the **03_Demo.ino** example program located in **"[Appendix\01 WonderLLM Development Environment Package\03_Demo](https://drive.google.com/drive/u/0/folders/1wAPikrh0M5ItXoU3reUM6BB61Y7EkHkN)"**.
...
2. Open the program **“[Appendix\03 WonderLLM Program\APCameraWebServer\APCameraWebServer.ino](https://drive.google.com/drive/u/0/folders/1u3XjTqKn3xf1ufkeQXgmmmCfeVGDF7jT)”**.
...
Open the **“[Appendix\03 WonderLLM Program\ FaceDetection\ FaceDetection.ino](https://drive.google.com/drive/u/0/folders/1_di2frnWM28lAtJ7_t3DwfKaoHSKxfwN)”** file located in the same directory as this document.
...
<img src="..\_static\media/chapter_3/section_3/media/image4.png" style="width:300px" class="common_img" />

5. Click <img src="..\_static\media/chapter_3/section_3/media/image5.png" class="inline-icon" /> to download the program to the WonderLLM and wait for the download to complete.
...
2. Open the serial debugging tool located at the path "**[Appendix\02 Serial Debugging Tool](https://drive.google.com/drive/u/0/folders/1e2k7DihGUfDa3qh4dnqEbZqEn5SianHD)**".
...
4. Click the <img src="..\_static\media/chapter_3/section_3/media/image8.png" class="inline-icon" /> button in the top-left corner of the page to open the serial communication. After WonderLLM recognizes a face, it will print the coordinates of the face in the serial monitor.
...
2. Open the program **“[Appendix\03 WonderLLM Program\ColorDetection\ColorDetection.ino](https://drive.google.com/drive/u/0/folders/15UVHzDd4hf95P9dZQL5P5-aK6anoDlKm)”**.
...
1. Open the file “**[Appendix\08 Color Threshold Adjustment Tool\HSV\HSV.dist\HSV.exe](https://drive.google.com/drive/u/0/folders/1LuoKRt_O8nQAk2nUts5W5f6b2XOW-xNG)**” located in the same path as this document.
...
4. After saving the HSV threshold values, open the file “**[Appendix\03 WonderLLM Program\ColorDetection\color_detection.cpp](https://drive.google.com/drive/u/0/folders/15UVHzDd4hf95P9dZQL5P5-aK6anoDlKm)**” (line 67) located in the same path as this document. Modify the color data by changing it to the saved HSV array. Finally, refer to “[3.4.2 Program Download](#anther3.4.2)” to flash the modified program into the WonderLLM module.
...
2. Open the program **“[Appendix\03 WonderLLM Program\LineTracking\LineTracking.ino](https://drive.google.com/drive/u/0/folders/10oqG7Q1MHz4BwKysgqUhuFvPum66HiKL)”**.
...
4. After saving the HSV threshold values, open the file “**[Appendix\03 WonderLLM Program\ColorDetection\color_detection.cpp](https://drive.google.com/drive/u/0/folders/15UVHzDd4hf95P9dZQL5P5-aK6anoDlKm)**” (line 33) located in the same path as this document. Modify the color data by changing it to the saved HSV array. Finally, refer to “[3.4.2 Program Download](#anther3.4.2)” to flash the modified program into the WonderLLM module.
...
(1) Locate and open the program file **“[Appendix\04 Arduino Program Files\01 Arduino Face Recognition Example\Arduino_esp32cam_face\Arduino_esp32cam_face.ino](https://drive.google.com/drive/u/0/folders/1qCBQ6nLJ8xzNi0896tRbD-mw9i9lYZL5)”**.
...
(2) Open the **“[Appendix\03 WonderLLM Program\ FaceDetection\ FaceDetection.ino](https://drive.google.com/drive/u/0/folders/1_di2frnWM28lAtJ7_t3DwfKaoHSKxfwN)”** file located in the same directory as this)
...
(1) Locate and open the program file **“[Appendix\04 Arduino Program Files\02 Arduino Color Recognition Example\Arduino_esp32cam_color\Arduino_esp32cam_color.ino](https://drive.google.com/drive/u/0/folders/14MPTolE_h_DR2wvNB4yCLWVhpVcaHQxU)”**.
...
<img src="../_static/media/chapter_3/section_7/media/image16.png" class="common_img" />

3. When WonderLLM detects green, print **COLOR_2** in the serial monitor.

<img src="../_static/media/chapter_3/section_7/media/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/media/image2_2.png" class="common_img"  />
...
(1) Locate and open the program file **“[Appendix\04 Arduino Program Files\03 Arduino Line-following Recognition Example\Arduino_esp32cam_linetrack\Arduino_esp32cam_linetrack.ino](https://drive.google.com/drive/u/0/folders/1emvBqyyBkA2XpvT48454TW_nH9kHZAa3)”**.
...
<img src="../_static/media/chapter_3/section_7/media/image2_1.png" class="common_img" />
...
<img src="../_static/media/chapter_2/section_2/media/image19.png" style="width:500px"  class="common_img" />
...
> * **If using ESP32, make sure that the MicroPython firmware is already installed on the ESP32 before downloading MicroPython. For firmware downloads, please visit the MicroPython official website. If using Hiwonder ESP32 core board, flash the firmware file provided by Hiwonder which located in "[Appendix\10 ESP32 Core Board Firmware and Flashing Tool\02 ESP32 Firmware Flashing Tool](https://drive.google.com/drive/folders/1FpJF0R0y9UWPeQMD1DXBGllqj5Pvsb74)". For flashing instructions, please refer to the document in the same path.**

1. Open the "**Hiwonder Python Editor**" software <img src="../_static/media/chapter_2/section_2/media/image1.png"  style="width:50px" /> which located in **"[Appendix\09 Hiwonder Python Editor](https://drive.google.com/drive/u/0/folders/1Dq-97y1GyllMpeqFTVXiDdgxbpQlF2F_)"**.

2. Drag the file "**[Appendix\05 ESP32 Program Files\01 ESP32 Controller Face Recognition Example\main.py](https://drive.google.com/drive/u/0/folders/1G7OtmVDNEP7kyw8g2pAyl36bqqgVCr3C)**" from this document's path into the Hiwonder Python editor. Make sure to drag it into the red-framed area for it to be valid.
...
> [!NOTE]
>**After completing the above 4 steps, please drag the WonderLLM offline vision feature communication library into the editor, which located in "[Appendix\ 05 ESP32 Program Files\ 01 ESP32 Controller Face Recognition Example\ hw_esp32cam_ctl.py](https://drive.google.com/drive/u/0/folders/1G7OtmVDNEP7kyw8g2pAyl36bqqgVCr3C)". Follow the same steps to import the library file into the ESP32. After downloading, click the reset icon on the interface <img src="../_static/media/chapter_3/section_8/media/image6_2.png"  style="width:50px" /> to reset the ESP32. The output information will be displayed in the output information bar below.**
...
1. When WonderLLM detects a face, it will print **find face** in the serial port.
   ...
   <img src="../_static/media/chapter_3/section_8/media/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_8/media/image2_1.png" class="common_img" />
...
<img src="../_static/media/chapter_2/section_2/media/image19.png" style="width:450px"  class="common_img" />


2. The ESP32 core board can be used in combination with Hiwonder open-source 6-channel servo controller, and the wiring to WonderLLM is shown in the diagram below:

<img src="../_static/media/chapter_2/section_2/media/image20.png" style="width:500px"  class="common_img" />
...
>
> * **MicroPython supports multiple IDEs for downloading, such as Thonny and VScode. Relevant plugins need to be installed, and the specific operations should be searched independently. This example uses the "Hiwonder Python Editor" for downloading the program without installation.**
> * **If using ESP32 controller, make sure that the MicroPython firmware is already installed on the ESP32 before downloading MicroPython. For firmware downloads, please visit the MicroPython official website. If using Hiwonder ESP32 core board, flash the firmware file provided by Hiwonder which located in "[Appendix\10 ESP32 Core Board Firmware and Flashing Tool\02 ESP32 Firmware Flashing Tool](https://drive.google.com/drive/u/0/folders/149R658NKUyWV8SfsLrWcMuYrJfOZ-IlI)". For flashing instructions, please refer to the document in the same path.**

1. Open the **Hiwonder Python Editor** software <img src="../_static/media/chapter_2/section_2/media/image1.png"  style="width:50px" /> which located in "**[Appendix\09 Hiwonder Python Editor](https://drive.google.com/drive/u/0/folders/1Dq-97y1GyllMpeqFTVXiDdgxbpQlF2F_)**".

2. Drag the file "**[Appendix\05 ESP32 Program Files\02 ESP32 Controller Color Recognition Example\main.py](https://drive.google.com/drive/u/0/folders/1Vd9MFo6Kxdw95fNskCXVqgFZXa496Edp)**" from this document's path into the Hiwonder Python editor. Make sure to drag it into the red-framed area for it to be valid.
...
> [!NOTE]
>**After completing the above 4 steps, please drag the WonderLLM offline vision feature communication library into the editor, which located in "[Appendix\05 ESP32 Program Files\02 ESP32 Controller Color Recognition Example\hw_esp32cam_ctl.py](https://drive.google.com/drive/u/0/folders/1Vd9MFo6Kxdw95fNskCXVqgFZXa496Edp)". Follow the same steps to import the library file into the ESP32. After downloading, click the reset icon on the interface <img src="../_static/media/chapter_3/section_8/media/image6_2.png"  style="width:50px" /> to reset the ESP32. The output information will be displayed in the output information bar below.**
...
Open the **“[Appendix\ 03 WonderLLM Program\ ColorDetection\ ColorDetection.ino](https://drive.google.com/drive/u/0/folders/15UVHzDd4hf95P9dZQL5P5-aK6anoDlKm)”** file located in the same directory as this document.
...
<img src="..\_static\media/chapter_3/section_3/media/image4.png" style="width:300px"  />
...
2. Drag the file "**[Appendix\05 ESP32 Program Files\03 ESP32 Controller Line-following Recognition Example\main.py](https://drive.google.com/drive/u/0/folders/1ZxWYei4FIk_ZTHt0u_rOOMtXZ_toDPhz)**" from this document's path into the Hiwonder Python editor. Make sure to drag it into the red-framed area for it to be valid.
...
4. After successful connection, click the download button on the menu bar <img src="../_static/media/chapter_2/section_2/media/image5.png"  style="width:50px" />, to download the program to the ESP32. Wait for the prompt in the information interaction box below to indicate that the download is complete.
   ...
   <img src="..\_static\media\chapter_2\section_2/media/image6.png" style="width:600px"  class="common_img" />
> [!NOTE]
>**After completing the above 4 steps, please drag the WonderLLM offline vision feature communication library  into the editor, which located in "[Appendix\05 ESP32 Program Files\03 ESP32 Controller Line-following Recognition Example\hw_esp32cam_ctl.py](https://drive.google.com/drive/u/0/folders/1ZxWYei4FIk_ZTHt0u_rOOMtXZ_toDPhz)". Follow the same steps to import the library file into the ESP32. After downloading, click the reset icon on the interface <img src="../_static/media/chapter_3/section_8/media/image6_2.png"  style="width:50px" /> to reset the ESP32. The output information will be displayed in the output information bar below.**
...
1. Please open the **flash_download_tool_3.9.7.exe** file located in the "**[Appendix\10 ESP32 Core Board Firmware and Flashing Software\02 ESP32 Firmware Flashing Tool](https://drive.google.com/drive/u/0/folders/1FpJF0R0y9UWPeQMD1DXBGllqj5Pvsb74)**" folder.
...
<img src="../_static/media/chapter_3/section_8/media/image2.png" class="common_img" />
...
(5) Click the **File** button on the software interface, select the file "**[Appendix\06 STM32 Program Files\01 STM32 Controller Face Recognition Example\RosRobotControllerM4-armclang\MDK-ARM\RosRobotControllerM4\RosRobotControllerM4.hex](https://drive.google.com/drive/u/0/folders/1-HLhGjQRSxuZEL7eyYmo1U4mb2JCkssy)**" for programming.
...
(5) Click the **File** button on the software interface, select the file "**[Appendix\06 STM32 Program Files\02 STM32 Controller Color Recognition Example\RosRobotControllerM4-armclang\MDK-ARM\RosRobotControllerM4\RosRobotControllerM4.hex](https://drive.google.com/drive/u/0/folders/1ODfsuSXsrefEmcwPXVI2nx4Npx5UgzpH)**" for programming.
...
(5) Click the **File** button on the software interface, select the file "**[Appendix\06 STM32 Program Files\03 STM32 Controller Line-following Recognition Example\RosRobotControllerM4-armclang\MDK-ARM\RosRobotControllerM4\RosRobotControllerM4.hex](https://drive.google.com/drive/u/0/folders/17eq0Y1x5u4chsw7HrIshsnzNQcl1DKwN)**" for programming.
...
(2) Upload the example file from "**[Appendix\07 Raspberry Pi Program Files\01 Raspberry Pi Face Recognition Example](https://drive.google.com/drive/u/0/folders/1ydOBRStrCXmluNDWZ2DHLOY2Iwu0lJGx)**" in the same directory as this document to any path on the Raspberry Pi using SSH or other methods.
...
<img class="common_img" src="..\_static\media/chapter_3/section_4/media/image1.png" width="300px" />
...
<img src="../_static/media/chapter_3/section_10/media/image13_1.png" class="common_img"/>
...
<img src="../_static/media/chapter_3/section_9/media/image2.png" class="common_img" />
...
(2) Upload the example file from "**[Appendix\07 Raspberry Pi Program Files\02 Raspberry Pi Color Recognition Example](https://drive.google.com/drive/u/0/folders/1gClv8WYRrbHM7BjSFP4VHiyBa9LQspjd)**" in the same directory as this document to any path on the Raspberry Pi using SSH or other methods.
...
(2) Open the “**[Appendix\ 03 WonderLLM Program\ColorDetection\ ColorDetection.ino](https://drive.google.com/drive/u/0/folders/15UVHzDd4hf95P9dZQL5P5-aK6anoDlKm)**” located in the same directory as this document.
...
1. When WonderLLM detects red, it will print **COLOR_1** in the serial monitor.
   ...
   <img src="../_static/media/chapter_3/section_10/media/image13.png" class="common_img" />

2. When WonderLLM detects green, print **COLOR_2** in the serial monitor.

   <img src="../_static/media/chapter_3/section_10/media/image14.png" class="common_img"/>
...
(2) Upload the example file from "**[Appendix\07 Raspberry Pi Program Files\03 Raspberry Pi Line-following Recognition Example](https://drive.google.com/drive/u/0/folders/1wmiiax59r6aNVpShCaIhzX1-3SiMnKtj)**" in the same directory as this document to any path on the Raspberry Pi using SSH or other methods.
