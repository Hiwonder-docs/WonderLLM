...
1. Open the **Hiwonder Python Editor** software <img src= "..\_static\media\chapter_2\section_2/media/image1.png"/> which located in "**[Appendix\02 Hiwonder Python Editor]()**".
...
Click here to access to the **[Appendix\01 MicroPython Program Files\main.py]()**.
...
Click here to access to the **[Appendix\06 XiaoZhi Open-Source Program Project]()**.
